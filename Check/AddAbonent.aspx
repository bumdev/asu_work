           ...
           <asp:Repeater runat="server" ID="repCorporate" 
                ...
                <ItemTemplate>               
                    ...
                    <div style="width:675px; padding:5px; background-color:#dddddd; border:1px solid black; margin-top:5px; border-radius:6px; -webkit-border-radius:6px; -moz-border-radius:6px; -khtml-border-radius:6px;">
                        <span style="font-size:14px; font-weight:bold;"> <asp:Literal runat="server" ID="litID_DOC" Text='<%# Eval("ID_DOC")%>'></asp:Literal> &nbsp;&nbsp;&nbsp;<asp:Literal runat="server" ID="litFULL_NAME" Text=<%# Eval("NAME_DOG")%>></asp:Literal></span>&nbsp;<span style="font-size:12px;"> (<asp:Literal runat="server" ID="litBUDZHET" Text=<%# Eval("BUDZHET")%>></asp:Literal>)</span><br/>
