        ...
        private void LoadStep3()
        {
            ...
            if (Session["Abonent"] != null)
            {
                ...
                if (hfClientType.Value == Abonent.Private.ToString())
                {
                    ...
                    (p.FindControl("FAbonDet2") as FAbonDet2018).OrderID = Utilities.ConvertToInt(hfOrder.Value);
                    (p.FindControl("FAbonDet2") as FAbonDet2018).Visible = true;
                    (p.FindControl("FAbonDet2") as FAbonDet2018).Bind();
                    CloseWizard();
