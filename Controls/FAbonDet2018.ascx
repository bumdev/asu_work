<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FAbonDet2018.ascx.cs" Inherits="kipia_web_application.Controls.FAbonDet2018" %>
...
<telerik:RadAjaxPanel runat="server" ID="up">
    ...
    <asp:Panel runat="server" ID="FAbonForm2018" Width="750px" Height="500px">
        ...
        <div style="width: 700px; min-height: 70px;">
            <div style="font-size: 14px; margin-top: 5px; float: left;">
                <b>
                    <asp:Literal runat="server" ID="litAbonentInfo2018" Visible="true"></asp:Literal></b>
        ...
        <div style="width: 500px; height: 25px; border: 0px solid black; float: left; padding-bottom: 75px;">
            ...
            <div style="margin-left: 10px; float:left; text-align: center; font-weight: bold; font-size: 14px; padding-top: 5px;">
                <asp:Button runat="server" ID="btActRubNew" Text="Акт" OnClick="btActRubNew_Click" />
            </div>
            
            <div style="margin-left: 10px; float: left; text-align: center; font-weight: bold; font-size: 14px; padding-top: 5px;">
                <asp:Button runat="server" ID="btNewActCheckRub" Text="Акт + квитанция" OnClick="btNewActCheckRub_Click" />
            </div>
        ...
        <div style="border: 1px solid black; width: 750px; height: 270px; overflow: auto;">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Цена">
                        <ItemTemplate>
                            ...
                            <asp:Literal runat="server" ID="physicalprice" Text='<%# Eval("physicalprice")%>'></asp:Literal>
                        </ItemTemplate>
                        <FooterTemplate>
            ...
            <asp:SqlDataSource ID="dsJournal" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionInfo %>"
                SelectCommand="RetrieveVodomersByOrderID2018"
                SelectCommandType="StoredProcedure"
                UpdateCommand="UpdateOrderDetails2018"
            ...
            <asp:SqlDataSource ID="dsJournal2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionInfo %>"
                SelectCommand="RetrieveVodomersByOrderID2018"
                SelectCommandType="StoredProcedure"
                UpdateCommand="UpdateOrderDetails22018"
                UpdateCommandType="StoredProcedure"
                DeleteCommand="DeleteOrderDetails2018"
