...
{
    public class FOrderDetails2018:UniversalEntity
    {
        #region Attributes
        ...
        public class FOrderDetailsAct2018 : FOrderDetails2018
        {
            int _OCount;
            string _SN;
            int _Diametr;
